...
- ComunicacionCliente
- comercial/services.py
- PlanPagosService
- TestCase
- Poliza
- DetectorConflictosService
- views_cotizador.py
- ICalParserService
...
- _generar_pdf_solicitud
- SolicitudFactura
- INTEGRACION.md
- CotizacionTotalesTest
- PolizaAdmin
- facturacion/models.py
- SolicitudFacturaAdmin
- Command
- TransicionEstadosTest
- ConflictoFechasTest
- CompraDeteccionAutomaticaTest
- PagoValidacionTest
- contabilidad/views.py
- facturacion/tests.py
- comercial.py
- LimpiarDatosFiscalesGenericosTest
- generar_lista_compras_barra
- ConciliacionPreliminarTest
- RenombrarUnidadNegocioEventosAQuintaMigrationTest
- GenerarCompraRetroactivaTest
- actualizar_item_cotizacion
- AsignacionEspacioTest
- DashboardSeparacionElianRubyTest
- ComunicacionSignalsTest
- ._buscar_anuncio
- limpiar_datos_fiscales_genericos.py
- 0044_recalcular_totales_iva.py
- 0002_cargar_catalogo_sat.py
- 0003_actualizar_regimenes_sat.py
- 0005_cargar_configuracion_contable.py
- .enviar_whatsapp_view
- facturacion.py
- setup_airbnb.py
- cargar_precios_mobiliario.py
- cerrar_cotizaciones.py
- 0058_compra_proveedor_catalogo.py
- _rangos_solapados
- Command
- 0008_cuenta_ajuste_apertura.py
- 0011_rename_contabilida_codigo__a1b2c3_idx_contabilida_codigo__b58027_idx_and_more.py
- 0012_renombrar_unidad_negocio_eventos_a_quinta.py
- .calcular_retenciones
- reporte_pagos_airbnb
- QktAuthConfig
- recalcular_iva.py
- 0018_proveedor_insumo_proveedor_legacy_and_more.py
- 0034_simplify_estados.py
- Actualización Módulo Airbnb v3
- 0047_seed_tipos_evento.py
- 0050_eliminar_montaje_de_lujo.py
- 0055_alter_imagenlanding_mostrar_en_galeria.py
- Command
- .get_full_url
- qkt_sidebar.py
- ContabilidadConfig
...
- .ver_plan_pagos
- .registrar_reembolso
- comercial/migrations/0001_initial.py
- 0002_compra_remove_gasto_archivo_pdf_and_more.py
- 0003_gasto_archivo_pdf_gasto_archivo_xml_and_more.py
- 0004_alter_gasto_categoria.py
- 0005_alter_pago_fecha_pago.py
- 0006_insumo_crear_como_subproducto.py
- 0007_cotizacion_horas_servicio_cotizacion_num_personas_and_more.py
- 0008_cotizacion_factor_utilidad_barra_and_more.py
- 0009_cotizacion_insumo_agua_and_more.py
- 0010_alter_insumo_categoria.py
- 0011_alter_compra_archivo_xml.py
- 0012_cotizacion_clima_alter_cotizacion_insumo_agua_and_more.py
- 0013_remove_cotizacion_tipo_barra_and_more.py
- 0014_remove_cotizacion_incluye_cocteleria_and_more.py
- 0015_alter_cotizacion_clima_and_more.py
- 0016_constantesistema_alter_cotizacion_clima_and_more.py
- 0017_insumo_presentacion_insumo_proveedor_plantillabarra.py
- 0019_factor_utilidad_barra_130.py
- 0020_movimientoinventario_cotizacion_cancelada_por_and_more.py
- 0021_planpago_parcialidadpago.py
- 0022_alter_movimientoinventario_options.py
- 0023_cotizacion_archivo_contrato_contratoservicio.py
- 0024_alter_contratoservicio_archivo_and_more.py
- 0025_recordatorio_pago.py
- 0026_add_solicitar_factura.py
- 0027_portalcliente.py
- 0028_add_unidad_negocio_compra.py
- 0029_alter_cotizacion_cliente.py
- 0030_pago_tipo.py
- 0031_espacio_cotizacion_tipo_servicio_asignacionpersonal_and_more.py
- 0032_producto_cotizador_fields.py
- 0033_cotizacion_tipo_arrendamiento.py
- 0035_landing_imagenes_testimonios.py
- 0036_imagenlanding_posicion_vertical.py
- 0037_espacios_faq_galeria_categorias.py
- 0038_producto_es_paquete_productocomponente.py
- 0039_producto_herencia_inventario.py
- 0040_producto_herencia_m2m_requiere_licor.py
- 0042_alter_imagenlanding_options_and_more.py
- 0045_alter_producto_grupo_cotizador.py
- 0046_temporada_tipoevento_descuento_descuentoaplicado_and_more.py
- 0051_alter_descuentoaplicado_options_and_more.py
- 0052_alter_descuento_options_and_more.py
- 0053_compra_cuenta_pago_alter_compra_unidad_negocio.py
- 0054_imagenlanding_mostrar_en_galeria.py
- 0056_pago_concepto.py
- 0057_compra_es_deducible.py
- ._intervalos
- .proveedor_display
- .calcular_inventario_inteligente
- .dias_para_evento
- .usos_disponibles
- .stock_bajo
- .clean
...
- .siguiente_pago
- .contiene
- comunicacion/migrations/0001_initial.py
...
- 0003_add_desglose_fiscal.py
- nomina/migrations/0001_initial.py
- 0002_alter_recibonomina_options.py
- 0003_recibonomina_estado_recibonomina_fecha_pago_and_more.py
...
### Community 29 - "_generar_pdf_solicitud"
Cohesion: 0.33
Nodes (4): _generar_pdf_solicitud(), Descarga el PDF de la solicitud., Genera el PDF de la solicitud y retorna los bytes., Envía email al contador con PDF adjunto.

### Community 30 - "SolicitudFactura"
Cohesion: 0.24
Nodes (5): Verifica si ya se subió la factura (PDF o ZIP)., Marca la solicitud como enviada., Marca la solicitud como facturada (cuando se sube el archivo)., Solicitud de factura enviada al contador.     Se puede generar automáticamente d, SolicitudFactura

### Community 31 - "INTEGRACION.md"
Cohesion: 0.03
Nodes (58): ============================================================, ──────────────────────────────────────────────────────────────, ], 1. core_erp/settings.py — INSTALLED_APPS, ──────────────────────────────────────────────────────────────, ──────────────────────────────────────────────────────────────, ──────────────────────────────────────────────────────────────, 2. core_erp/settings.py — JAZZMIN_SETTINGS icons (+50 more)

### Community 32 - "CotizacionTotalesTest"
Cohesion: 0.26
...
### Community 41 - "contabilidad/views.py"
Cohesion: 0.28
...
### Community 42 - "facturacion/tests.py"
Cohesion: 0.22
Nodes (6): _crear_cotizacion(), TestCase, Tests del módulo Facturación ============================, Regresión: un pago de un cliente SIN datos fiscales debe generar una     solicit, No debe romperse el caso normal: cliente con datos fiscales reales., SolicitudFacturaClienteNoFiscalTest

### Community 43 - "comercial.py"
Cohesion: 0.25
...
### Community 51 - "DashboardSeparacionElianRubyTest"
Cohesion: 0.29
...
### Community 58 - "0003_actualizar_regimenes_sat.py"
Cohesion: 0.33
...
### Community 59 - "0005_cargar_configuracion_contable.py"
Cohesion: 0.33
...
### Community 60 - ".enviar_whatsapp_view"
Cohesion: 0.20
Nodes (6): _enviar_pdf_whatsapp(), Genera el PDF y lo envía al contador via WhatsApp Cloud API., Envía el PDF de la solicitud al contador via WhatsApp Cloud API.     1. Sube el, Genera el texto con datos para enviar al contador., Genera URL de WhatsApp con los datos para el contador., Retorna el contador activo o None.

### Community 61 - "facturacion.py"
Cohesion: 0.33
...
### Community 68 - "0008_cuenta_ajuste_apertura.py"
Cohesion: 0.40
...
### Community 69 - "0011_rename_contabilida_codigo__a1b2c3_idx_contabilida_codigo__b58027_idx_and_more.py"
Cohesion: 0.40
...
### Community 70 - "0012_renombrar_unidad_negocio_eventos_a_quinta.py"
Cohesion: 0.40
...
### Community 75 - "0018_proveedor_insumo_proveedor_legacy_and_more.py"
Cohesion: 0.50
...
### Community 77 - "Actualización Módulo Airbnb v3"
Cohesion: 0.12
Nodes (15): 1. iCal Inverso (ERP → Airbnb), 1. Reemplazar archivos en `airbnb/`, 2. Actualizar `airbnb/models.py`, 2. Bloqueo Manual, 3. Actualizar `core_erp/urls.py`, 4. Migraciones, 5. Subir cambios, Actualización Módulo Airbnb v3 (+7 more)

### Community 80 - "0055_alter_imagenlanding_mostrar_en_galeria.py"
Cohesion: 0.50
...
Cohesion: 0.22
Nodes (3): TestCase, Guardrail: precio_venta_fijo=0.00 (placeholder pendiente) no debe         expone, SugerenciaPrecioTests

### Community 207 - "facturacion/admin.py"
Cohesion: 0.25
