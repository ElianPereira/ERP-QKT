...
class Producto(models.Model):
    ...
    # Categorías reales del negocio (Issue #287): un extra de Evento/Pasadía/
    # Hospedaje se agrupa así en el cotizador público, sea cual sea el
    # servicio — `api_productos_cotizador` las usa tal cual, sin distinguir
    # servicio. Las últimas cuatro quedan solo por compatibilidad con
    # productos ya categorizados antes de este cambio: un producto nuevo no
    # debería usarlas. Recategorizar lo existente es trabajo de captura del
    # propietario (ver Memoria), no algo que el código pueda inferir solo.
    GRUPO_COTIZADOR_CHOICES = [
        ...
        ('COMIDA', 'Alimentos y Bebidas (obsoleto, recategorizar en Alimentos/Bebidas)'),
