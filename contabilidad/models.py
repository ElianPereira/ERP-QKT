...
from core_erp.validadores_archivos import extension_pdf_o_xml, validar_firma_pdf_o_xml
...
# (antes había una copia local que había divergido: le faltaban los códigos
# 609/628/629/630 y difería en 4 etiquetas respecto al catálogo de facturación).
REGIMEN_FISCAL_SAT_CHOICES = RegimenFiscal.choices
...
class EstadoCuentaBancario(models.Model):
    ...
    archivo = models.FileField(
        ...
        validators=[extension_pdf_o_xml, validar_firma_pdf_o_xml],
    )
